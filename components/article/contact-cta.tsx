...
export function ContactCTA({
  ...
  return (
    <div className="my-10 rounded-[14px] border-2 border-[#be1e2d] bg-[#fdf3f4] px-6 py-8 text-center max-w-[620px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#be1e2d] hover:bg-[#8f1622] text-white font-extrabold text-[17px] px-6 py-4 rounded-[10px] transition-colors no-underline"
        >
          📞 Call {phoneDisplay}
        </a>
      </div>
