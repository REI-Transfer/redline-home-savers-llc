...
// Advertorial editorial landing page (v2 "equity-opportunity" angle) for Redline Home
// Savers LLC. Market/company/owner all come from server config via props, so there is
// no hardcoded city. This repo's SurveyCard uses the single-stage signature
// (phoneDisplay/phoneHref/serviceAreas) plus the additive initialAddress/initialStep
// seed so the sticky top bar opens the form at question 2 with the address already
// captured. ALL CTAs open the popup. No countdown timers, no fake urgency, no
// trust-stats strip. Tuned for a 45+ seller. Never touches the form, webhook, or phone.
...
// Normalize the configured phone into a clean dialable string. PHONE_HREF may arrive
// as "tel:(949)201-6412", so strip everything but digits and assume US.
...
export function AdvertorialPage({
  ...
  const tel = `tel:${dialable(phoneHref)}`

  // Editorial palette (CTA stays the same warm green across all clients; the brand
  // accent only drives the brand-colored number boxes and step badges).
  const C = {
    text: "#1a1a1a",
    muted: "#6b6b6b",
    link: accentColor,
  ...
  // Top bar autocompletes. When they pick a real suggestion we capture the validated
  ...
  return (
    <div style={{ color: C.text, background: "#fff" }}>
      <article className="mx-auto max-w-[760px] px-6 pt-6 md:pt-10 pb-36 text-[18px] md:text-[19px] leading-[1.7]">
        ...
        <header>
          <h1 className="text-[24px] md:text-[34px] leading-[1.18] font-extrabold text-center mb-[12px] tracking-[-0.01em]">
            {market === "your area" ? "" : `${market} `}Homeowners 45 And Older: There Is A Quiet Way To Pull The Cash Out Of An Older Home Without Listing It.
          </h1>
          <p className="text-center text-[17px] md:text-[20px] font-semibold mb-[10px] leading-[1.4]">
            See Your 24-Hour Cash Offer Estimate. No Repairs, No Showings, No Agent.
          </p>
          <p style={{ color: C.muted }} className="text-center text-[15px] mb-[18px] leading-[1.45]">
            Best suited to dated or inherited homes that need work, and owners who want speed and a number they can count on.
          </p>
        ...
        <figure className="my-[8px] mb-[30px]">
          <Image src="/images/adv-strangers-open-house.jpg" alt="Unfamiliar visitors walking through a home during an open house" width={760} height={500} className="block w-full h-auto rounded-[3px] bg-gray-100" priority />
          <figcaption style={{ color: C.muted }} className="text-[13px] text-center mt-2 italic">
            An open house parks people you have never met in your living room week after week. More homeowners across {where} are quietly skipping that whole circus.
          </figcaption>
        </figure>
        ...
        <div style={{ border: `1px solid ${C.rule}` }} className="rounded-[10px] px-4 py-3.5 mb-[30px] flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[14px] leading-[1.45] mb-1">{`"They took our tired old place exactly how it sat, and we had cash in hand inside two weeks. We never fixed a thing." `}<cite style={{ color: C.muted }} className="not-italic">Eileen R.</cite></p>
            <p style={{ color: C.muted }} className="text-[12.5px] leading-[1.4]">A local, BBB-accredited cash buyer serving {where}. Real written offers, no obligation.</p>
          </div>
        </div>

        {/* Equity-opportunity opening */}
        <section>
          <p className="mb-[14px]">There is a number most homeowners past 45 have never once stopped to add up.</p>
          <p className="mb-[14px]"><strong>You spent years quietly knocking down this mortgage while the neighborhood grew up around you.</strong></p>
          <p className="mb-[14px]">All that patience turned into something real. Equity. Usually a fair bit more of it than people guess.</p>
          <p className="mb-[14px]">But equity locked inside the walls does not lift a finger for you.</p>
          <p className="mb-[14px]">It does not book the trip. It does not move you closer to the grandkids. It does not take a single worry off your retirement.</p>
          <p className="mb-[14px]">It only starts working for you the day you turn it into cash you can actually hold.</p>
          <p className="mb-[14px]">And no one can promise next year looks like this one. Meanwhile the property taxes, the insurance, and the upkeep on an older home have not gotten any kinder to your wallet.</p>
          <p className="mb-[14px]"><strong>So the real question is not what you might list it for someday. It is what you can walk away with, and how soon.</strong></p>
        </section>
        ...
        <aside style={{ border: `1px solid ${C.rule}`, background: "#fafafa" }} className="rounded-[12px] px-6 py-[26px] my-[34px]">
          <h3 className="text-[20px] md:text-[22px] font-extrabold text-center mb-1.5">Exactly How Selling To {companyName} Works</h3>
          ...
          <ul className="space-y-3.5">
            ...
            <li className="flex gap-3"><span style={{ background: C.accent }} className="shrink-0 w-[28px] h-[28px] rounded-full text-white text-[15px] font-extrabold flex items-center justify-center">3</span><span><strong>You choose the closing day.</strong> No repairs, no showings, no fees. The offer is yours to keep and sit with as long as you like.</span></li>
          </ul>
        </aside>

        <Cta label="See What My Home Qualifies For →" />

        <H2>The House Slowly Grew As The Years Rolled On</H2>
        <FullImage src="/images/adv-empty-rooms.jpg" alt="Quiet rooms in a longtime family home that now sit mostly empty" />
        <section>
          <p className="mb-[18px]">This is the part nobody warns you about ahead of time.</p>
          <p className="mb-[18px]">The square footage never changes. You are the one who does. One by one, the rooms you used to fill go still. The garage fills with boxes you can no longer lift. The upstairs turns into a place you visit instead of a place you live.</p>
          <p className="mb-[18px]">And the upkeep keeps right on knocking. A home this age always has its hand out. A fresh coat of paint. A new furnace before another winter. The gutters, yet again.</p>
          <p className="mb-[18px]">Here is the blunt part most folks slam into: <strong>fixing the place up just to put it on the market can cost more than the cash you set aside, and pull more out of you than you ever planned to give.</strong></p>
          <p className="mb-[18px]">So the house waits. The decision waits. And one more season quietly slips by.</p>
        </section>

        <H2>What Pulling That Equity Out The Old Way Quietly Costs You</H2>
        <FullImage src="/images/adv-couple-window.jpg" alt="An older couple standing in the family home they have owned for years" />
        <section>
          <p className="mb-[18px]">The first instinct is to list it. Stake a sign in the yard, chase top dollar, and walk off with the whole pile. For a younger household with the time and the budget to fix the place up first, that road can absolutely work, and we will be the first to say so.</p>
          <p className="mb-[18px]">But here is what listing actually does to the equity you are trying to capture. It takes a real bite out of it long before a single dollar reaches you:</p>
          <ul className="mb-[18px] pl-[22px] list-disc">
            <li className="mb-2"><strong>You pay for the repairs first.</strong> The agent shows up with a list. Paint, flooring, the roof. Money leaving your pocket before one buyer ever walks the door.</li>
            <li className="mb-2"><strong>Strangers roam through your home.</strong> Open houses put people you have never met inside your closets while you wait it out in the car.</li>
            <li className="mb-2"><strong>You wait. Then you wait some more.</strong> A typical listing can take two or three months to reach the closing table, sometimes longer, and the whole thing can still collapse at the finish line.</li>
            <li className="mb-2"><strong>The fees stack up.</strong> Between commission and closing costs, a thick slice of your price quietly vanishes. On plenty of homes that is tens of thousands gone right off the top.</li>
          </ul>
          <p className="mb-[18px]">So listing is not wrong. <strong>But for a home that needs work and an owner who would rather not run a part-time job for three months, the math and the certainty simply point a different way.</strong></p>
        </section>

        <Cta label="See What My Home Qualifies For →" />

        <H2>Why A Cash Sale Is The Cleanest Way To Keep Your Equity</H2>
        <FullImage src="/images/adv-handshake.jpg" alt="A relaxed handshake between a homeowner and a local cash home buyer" />
        <section>
          <p className="mb-[18px]">These last few years, more and more homeowners past 45 have set the old listing routine down and picked something far simpler.</p>
          ...
          <p className="mb-[18px]">It will not be right for everyone. If you have all the time in the world, the budget for a full renovation, and the patience for a three month listing, the traditional path is still sitting there waiting on you.</p>
          <p className="mb-[18px]">But once you weigh it honestly, for a home that needs work and an owner who wants the money in hand without the wait or the risk, <strong>a clean cash sale is simply the strongest card on the table. You keep more of what the home is worth, you keep your privacy, and you keep control of the calendar.</strong></p>
        </section>
        ...
        <section>
          ...
          <p className="mb-[18px]">A listing punishes a home that needs work. It corners you: pour cash into repairs you will never fully earn back, or sit there fielding the lowball offers buyers toss at anything that is not picture perfect.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-[30px]">
          <div style={{ border: `1px solid ${C.rule}` }} className="rounded-[12px] p-5">
            ...
            <ul className="space-y-2.5 text-[15px]">
              ...
              <li>It can still fall apart at the table</li>
            </ul>
          </div>
        ...
        <section>
          ...
          <p className="mb-[18px]">If the offer is not the right fit, there is no arm-twisting and nothing owed. The written offer is yours to keep and mull over for as long as you please.</p>
        ...
        <H2>Why It Fits This Season Of Life</H2>
        <section>
          <ul className="mb-[18px] pl-[22px] list-disc">
            ...
            <li className="mb-2"><strong>Keep more of your money.</strong> No commission and no closing costs chewing into your retirement.</li>
            <li className="mb-2"><strong>Move on your own schedule.</strong> Close fast, or take all the time you need. You keep the calendar, not some buyer.</li>
          ...
          <p className="mb-[18px]">That is why, once homeowners past 45 see how this runs, so many of them say the very same thing: <em>I wish someone had told me this was on the table years ago.</em></p>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-5 my-[30px] mb-10">
          {[
            ...
            { img: "/images/adv-testimonial-2.jpg", quote: "We were moving to be near our daughter and had no stomach for months of showings at our age. They handed us a fair written offer inside a couple of days and let us close once we were ready. Straight shooters. No games.", cite: "Robert and Jean D., 68 and 66" },
        ...
        <section className="my-[30px]">
          {[
            ...
            { q: "How do you decide on the offer?", a: `We look at where your home sits, its current condition, and recent sales of comparable homes nearby across ${where}. Then we show you the plain math behind the number. No black box. You see how we got there before you ever commit.` },
        ...
        <section>
          ...
          <p className="mb-[18px]">You gave that home a lifetime of care. By now it ought to be looking after you, not the other way around. The simplest first step is to find out what it qualifies for. That costs you nothing, and it commits you to nothing.</p>
        </section>
        ...
        <aside style={{ border: "2px dashed #bdbdbd" }} className="rounded-[10px] px-7 py-[30px] max-w-[600px] mx-auto mt-[40px] text-center">
          ...
          <p className="mt-4 text-[14px]">Prefer to talk it through?<br className="sm:hidden" /> Call us at{" "}
            <a href={tel} style={{ color: C.accent }} className="font-bold underline underline-offset-2 whitespace-nowrap">{phoneDisplay}</a>
          </p>
        </aside>
      ...
      {/* ============ POPUP: form opens at question 2, address already captured ============ */}
      {modalOpen && (
